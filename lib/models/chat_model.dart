...
//     Content.text('input: When user inquires about common TOEIC idioms, explain and provide examples.'),
...
//     Content.text('output: Practice speaking with a language partner, record yourself, and use language learning apps for speaking exercises.  Other techniques include:  Shadowing native speakers, focusing on pronunciation, practicing common phrases, and participating in conversations.  For example, record yourself reading a passage and then compare it to a native speaker\'s recording.'),
...
//     Content.text('output: Focus on identifying the main subject and action in the photograph.  Listen carefully to the descriptions and pay attention to details.  Practice identifying common vocabulary related to workplace settings and activities.  For example, if you see a photograph of someone working at a computer, you might expect to hear words like \'typing\', \'keyboard\', \'monitor\', \'office\', or \'desk\'.'),
